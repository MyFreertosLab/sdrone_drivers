...
esp_err_t mpu9250_acc_load_cal_data(mpu9250_handle_t mpu9250_handle) {
	...
	mpu9250_handle->data.cal_data.data_s_xyz.accel_data_x = mpu9250_handle->data.accel.cal.factors[Z_POS][X_POS]*(mpu9250_handle->data.raw_data.data_s_xyz.accel_data_x - mpu9250_handle->data.accel.cal.offsets[X_POS]) + mpu9250_handle->data.accel.cal.factors[Z_POS][Y_POS]*(mpu9250_handle->data.raw_data.data_s_xyz.accel_data_y - mpu9250_handle->data.accel.cal.offsets[Y_POS]) + mpu9250_handle->data.accel.cal.factors[Z_POS][Z_POS]*(mpu9250_handle->data.raw_data.data_s_xyz.accel_data_z - mpu9250_handle->data.accel.cal.offsets[Z_POS]);
	return ESP_OK;
}
